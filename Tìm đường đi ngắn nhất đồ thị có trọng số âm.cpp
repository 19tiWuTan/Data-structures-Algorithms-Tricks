/*
  ...
  m cạnh vô hướng (ui, vi) có trọng số m / 2 <= 5e5
  p cạnh có hướng (xi, yi) có trọng số p / 3 <= 5e5, đảm bảo không có đường đi từ yi đến xi, điều này đảm bảo đồ thị khong có chu trình
